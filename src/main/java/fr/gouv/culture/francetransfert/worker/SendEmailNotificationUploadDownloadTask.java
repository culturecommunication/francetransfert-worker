...
public class SendEmailNotificationUploadDownloadTask implements Runnable { 
	...
	public SendEmailNotificationUploadDownloadTask(String enclosureId, RedisManager redisManager, MailAvailbleEnclosureServices mailAvailbleEnclosureServices) {
