...
public class MailConfirmationCodeNotificationTest {
        ...
        public void setUp() throws Exception {
            ...
            enclosure = Enclosure.builder()
                    .guid("enclosureId")
                    .rootFiles(Arrays.asList(new RootData("file_1","txt", WorkerUtils.getFormattedFileSize(12),"file_2"), new RootData("file_2", "txt",WorkerUtils.getFormattedFileSize(5),"file_2")))
