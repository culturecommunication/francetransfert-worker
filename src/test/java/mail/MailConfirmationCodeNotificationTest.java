...
public class MailConfirmationCodeNotificationTest {
	...
	public void setUp() throws Exception {
		...
		enclosure = Enclosure.builder().guid("enclosureId")
				...
				.recipients(Arrays.asList(new Recipient("e4cce869-6f3d-4e10-900a-74299602f460", "louay.haddad@gouv.fr"),
						new Recipient("6efb01a7-bd3d-46a9-ac12-33085f76ce1c", "louayhadded2012@gmail.com")))
