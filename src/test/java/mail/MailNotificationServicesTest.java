...
public class MailNotificationServicesTest {
    ...
    public void setUp() throws Exception {
       ...
       enclosure = Enclosure.builder()
                .guid("enclosureId")
               .rootFiles(Arrays.asList(new RootData("file_1.txt", "txt", WorkerUtils.getFormattedFileSize(12),"file_2"), new RootData("file_2.txt", "txt", WorkerUtils.getFormattedFileSize(5),"file_2")))
                .rootDirs(Arrays.asList(new RootData("dir_1", null, WorkerUtils.getFormattedFileSize(120),"file_2"), new RootData("dir_2", null, WorkerUtils.getFormattedFileSize(50),"file_2")))
                .countElements(2)
